...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        now = self.place
        t = 0
        while t < self.max_range and (len(now.bees) == 0 or t < self.min_range) and now.entrance.is_hive == False:
            now = now.entrance
            t += 1
        return random_bee(now.bees) # REPLACE THIS LINE
        # END Problem 3 and 4
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        if self.chew_countdown == 0:
            return self.eat(random_bee(self.place.bees))
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8
        return self.is_container and not self.ant_contained and not other.is_container
        # END Problem 8
    ...
    def action(self, gamestate):
        ...
        if self.ant_contained:
            self.ant_contained.action(colony)
        # END Problem 8
...
class TankAnt(BodyguardAnt):
    ...
    def action(self, colony):
        m = list(self.place.bees)
        for n in m:
            n.reduce_health(self.damage)
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        """
        # BEGIN Problem 12
        cls.first_queen = False
        if QueenAnt.have_queen == False:
            QueenAnt.have_queen = True
            cls.first_queen = True
        # END Problem 12
    ...
    def action(self, gamestate):
        ...
        """
        # BEGIN Problem 12
        if self.first_queen == True:
            ScubaThrower.action(self, colony)
            while self.place.exit != None:
                self.place = self.place.exit
                if self.place.ant not in self.behind:
                    self.behind.append(self.place.ant)
                    self.place.ant.damage*=2
        elif self.first_queen == False:
            self.reduce_armor(self.health)
        # END Problem 12
    ...
    def reduce_health(self, amount):
        ...
        # BEGIN Problem 12
        Ant.reduce_health(self,amount)
        if self.first_queen==True and self.armor ==0:
            bees_win()
        # END Problem 12
